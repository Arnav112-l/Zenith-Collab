      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="bg-[var(--surface-2)] rounded-2xl border border-[var(--border)] p-6">
          <div className="flex items-center justify-between">
            <h2 className="text-3xl font-bold text-[var(--foreground)]">Monthly Budget Manager</h2>
            {!readOnly && (
              <select
                value={currency}
                onChange={(e) => handleCurrencyChange(e.target.value)}
                className="bg-[#27272a] text-[var(--foreground)] rounded-lg px-4 py-2 border border-[#3f3f46] focus:outline-none focus:border-[#f472b6]"
              >
                {CURRENCIES.map((curr) => (
        ...
        <div className="bg-[var(--surface-2)] rounded-2xl border border-[var(--border)] p-6">
          <h3 className="text-[var(--foreground)] font-semibold text-lg mb-4">Monthly Income</h3>
          {!readOnly ? (
            <div className="flex gap-3 mb-4">
              <input
                ...
                className="flex-1 bg-[#27272a] text-[var(--foreground)] rounded-lg px-4 py-3 border border-[#3f3f46] focus:outline-none focus:border-[#f472b6]"
              />
              <button
                onClick={handleSetIncome}
                className="bg-green-500 hover:bg-green-600 text-[var(--foreground)] px-6 py-3 rounded-lg transition-colors font-semibold"
              >
                Set Income
              </button>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div className="bg-[var(--surface-2)] p-6 rounded-2xl border border-[var(--border)]">
            ...
            <p className="text-2xl font-bold text-[var(--foreground)]">{currencySymbol}{totalAllocated.toLocaleString()}</p>
          </div>
          <div className="bg-[var(--surface-2)] p-6 rounded-2xl border border-[var(--border)]">
        ...
        {categoryData.length > 0 && (
          <div className="bg-[var(--surface-2)] rounded-2xl border border-[var(--border)] p-6">
            <h3 className="text-[var(--foreground)] font-semibold mb-4 text-lg">Budget Allocation</h3>
        ...
        <div className="bg-[var(--surface-2)] rounded-2xl border border-[var(--border)] p-6">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-[var(--foreground)] font-semibold text-lg">Budget Categories</h3>
          </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-[var(--surface-2)] text-[var(--foreground)] text-sm rounded px-3 py-2 border border-[#3f3f46] focus:outline-none focus:border-red-400"
                      />
                    </div>
                  </div>
                )}
        ...
        <div className="bg-[var(--surface-2)] rounded-2xl border border-[var(--border)] p-6">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h3 className="text-[var(--foreground)] font-semibold text-lg">Recurring Expenses</h3>
          </div>
              ...
              <div key={item.id} className="flex items-center justify-between bg-[#27272a]/30 rounded-lg p-4">
                <div className="flex-1">
                  <div className="flex items-center gap-2">
                    <h4 className="text-[var(--foreground)] font-medium">{item.name}</h4>
            ...
            {!readOnly && (
              <div className="bg-[#27272a]/30 rounded-lg p-4 border-2 border-dashed border-[#3f3f46]">
                ...
                <select
                  ...
                  className="w-full bg-[var(--surface-2)] text-[var(--foreground)] text-sm rounded px-3 py-2 mb-3 border border-[#3f3f46] focus:outline-none focus:border-[#f472b6]"
                >
        ...
        <div className="bg-[var(--surface-2)] rounded-2xl border border-[var(--border)] p-6">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h3 className="text-[var(--foreground)] font-semibold text-lg">Savings Goals</h3>
          </div>
            ...
            {savingsGoals.map(goal => (
              <div key={goal.id} className="bg-[#27272a]/30 rounded-lg p-4">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex-1">
                    <div className="flex items-center gap-2">
                      <h4 className="text-[var(--foreground)] font-medium">{goal.name}</h4>
                      {goal.isMonthly && (
                ...
                {!readOnly && (
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-[var(--surface-2)] text-[var(--foreground)] text-sm rounded px-3 py-2 border border-[#3f3f46] focus:outline-none focus:border-green-500"
                    />
                  </div>
                )}
              </div>
